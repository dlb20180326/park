	...
	<div id="loginPage">
		...
		<form id="myForm">
			<div class="input-all clearfix">
				...
				<input type="text" id="in-phone" v-model="account" @focus="acountCheck" value="wangjie" required />
			</div>
			<div class="input-all clearfix">
				<div class="left-content">
					<i class="img-locks"></i>
				...
				<input type="password" id="in-phone" v-model="pass" value="12345678" required />
			</div>
			<div class="passAbout">
