          ...
          <!--  <flexbox-item>
            ...
            <section class="mainbox">
                <div class=" clearfix p15 display">
                    ...
                    <a  class=" fr"> <router-link slot="right" to="/active/activityMore">查看全部 ></router-link></a>
                </div>
...
import { XHeader, Flexbox, FlexboxItem, cookie,Cell,Group,XButton,Alert,XTable,TransferDomDirective as TransferDom } from 'vux';
