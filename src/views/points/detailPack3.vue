<template>
    <div class="page-body">
            ...
            <div class="page-body">
                ...
                <view-box ref="viewBox" body-padding-top=".2rem">
                    ...
                    <p class="allPic">
                        ...
                        <span class="numberz1">{{departmentname}}</span>
                    </p>
                    <p class="allPic">
                        <span class="bg-line"></span>
                    ...
                    methods: {
                        ...
                        getList1(){
                            ...
                            detailId=12
                                ...
                                console.log("11111123213213",res);
        ...
        <view-box ref="viewBox" body-padding-top=".2rem">
            ...
            <p class="allPic">
                <span class="bg-line"></span>
                <span class="picture">所属支部:</span>
                <span class="numberz1">{{departmentname}}</span>
            </p>
            <p class="allPic">
                <span class="bg-line"></span>
                <span class="picture">扣分原因:</span>
            </p>
            <div class="artical">
                {{content1}}
            </div>
