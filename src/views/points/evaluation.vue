		...
		methods:{
			...
			removes(){
				if(this.$store.getters.user.roleid == 3){
					this.collect = [{moduleid:2,bgImg:require('@/assets/images/icon-idea.png'),label:'政治学习',score:'10分'},
                        {moduleid:4,bgImg:require('@/assets/images/icon-life.png'),label:'组织生活双报道',score:'20分'},
					{moduleid:11,bgImg:require('@/assets/images/icon-idea.png'),label:'思想汇报',score:'15分'},
                        ...
                        {bgImg:require('@/assets/images/icon-law.png'),label:'遵纪守法一票否决',score:'20分'},
