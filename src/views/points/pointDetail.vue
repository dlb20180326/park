<template>
    <div class="page-body">
        ...
        <section class="mainbox">
            <div style="padding:2vw 3.5vw 2vw;">
                <table width="100%" class="table">
                    ...
                    <tr>
                        <td>现有积分：</td>
                        <td class="f_b"><span class="red">43</span></td>
                    </tr>
                </table>
            </div>
        ...
        <section class="mainbox">
            ...
            <div style="padding:2vw 3.5vw 6vw;">
                <table width="100%" class="table">
                    <tr>
                        <td width="100">获取时间：</td>
                        <td class="f_b">2018.05.27</td>
                    </tr>
                    <tr>
                        <td>积分类型：</td>
                        <td class="f_b">党费缴纳党费缴纳党费缴纳</td>
                    </tr>
                    <tr>
                        <td>审核人：</td>
                        <td class="f_b">支部书记</td>
                    </tr>
                    <tr>
